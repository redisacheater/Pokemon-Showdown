...
exports.commands = {
	credits: function (target, room, user) {
        ...
        "- " + WL.nameColor('Pokem9n', true) + " (Owner, Sysadmin, Policy Admin, Server Host)<br />" +
"- " + WL.nameColor('Ryan3770', true) + " (Owner, Sysadmin, Policy Admin, Server Host)<br />" +
        ...
        "- " + WL.nameColor('Xprienzo', true) + " (Technical Admin, Development)<br/>" +

"- " + WL.nameColor('LightiumZ', true) + " (Technical Admin, Development)<br/>" +
